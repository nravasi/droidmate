...
public class InitConstants
{
  ...
  static {
    ...
    if (!monitor_generator_apk_scaffolding_local_properties_file.exists())
    {
      ...
      monitor_generator_apk_scaffolding_local_properties_file.write("sdk.dir=" + LocalInitConstants.android_sdk_dir.path)
    }
    ...
    if (Files.notExists(uiautomator_daemon_local_properties_file))
    {
      ...
      uiautomator_daemon_local_properties_file.write("sdk.dir=" + LocalInitConstants.android_sdk_dir.toString())
    }

    if (Files.notExists(apk_fixtures_src_local_properties_file))
    {
      assert Files.createFile(apk_fixtures_src_local_properties_file)
      apk_fixtures_src_local_properties_file.write("sdk.dir=" + LocalInitConstants.android_sdk_dir.toString())
    }
